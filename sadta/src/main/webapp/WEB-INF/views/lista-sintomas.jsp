      ...
      <div class="wrapper ">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
               <div class="container-fluid">
                  <div class="navbar-wrapper">         
                     <a class="navbar-brand" href="#">Registro de Sintomas</a>
                  </div>
               </div>
            </nav>
            <!-- End Navbar -->
        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Sintomas Registrados</h4>
              </div>
              <div class="card-body">
                  ...
                  <table class="table fonte-reduzida">
                    ...
                    <tbody>
                      <c:forEach var="sintoma" items="${sintomas}">
                      		<tr>
                      			<td>${sintoma.nomeSintoma}</td>
                      			<td>
                      				${sintoma.tipoSintoma}
                      			</td>
                      			<td>
                      				<form class="form-text" action="exibir-curso" method="post">
                      					<input type="text" value="${sintoma.codigoSintoma}" name="codigoSintoma" hidden="true">
