            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
               <div class="container-fluid">
                  <div class="navbar-wrapper">         
                     <a class="navbar-brand" href="#">Registro de Situações</a>
                  </div>
               </div>
            </nav>
            <!-- End Navbar -->
        ...
        <div class="row">
          ...
          <div class="card">
          	<div class="card-header">
            	<h4 class="card-title">Registro de Situações</h4>
            </div>
            <div class="card-body">
            	<div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Situações Registradas</h4>
              </div>
              <div class="card-body">
                      		...
                      		<tr>
                      			...
                      			<td>
                      				<form class="form-text" action="exibir-curso" method="post">
                      					<input type="text" value="${situacao.codigoSituacao}" name="codigoSituação" hidden="true">
