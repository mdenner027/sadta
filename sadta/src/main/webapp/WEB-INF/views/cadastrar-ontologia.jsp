            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
               <div class="container-fluid">
                  <div class="navbar-wrapper">         
                     <a class="navbar-brand" href="#">Registro de Cursos</a>
                  </div>
               </div>
            </nav>
            <!-- End Navbar -->
            ...
            <div class="content">
               <div class="card">
                  <div class="card-header">
                     <h5 class="title">Registrar Ontologia</h5>
                  </div>
                  <div class="card-body">
                     <form action="insert-ontology" method="post">
                        <fieldset>
                           <legend>Arquivo da Ontologia</legend>
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                   <label class="custom-file-label" for="customFile">File Input</label>
                                    <input type="file" name="versaoOntologia" class="custom-file-input" placeholder="Escolher arquivo" id="customFile">
                                 </div>
                              </div>
                              </div>
                              </fieldset>
                       ...
                       <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <button type="submit" class="form-control btn btn-success">Cadastrar Ontologia&nbsp;<i class="now-ui-icons ui-1_check"></i></button>
                              </div>
                           </div>
                        </div>
                     </form>
                      <form action="controller" id="voltar" method="post">
                      		<input type="text" name="mvc" value="ListaCursosLogica" hidden="true"/>
                      </form>
                  </div>
               </div>
            </div>
