...
<body>
	...
	<script>
	    function ativaMenu(){
	    	document.getElementById("caso-teste").classList.add("active");
	    }
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="page-section" id="overview">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <h2 class="page-header">Analisar caso de teste</h2>
                                    <p class="">
                        ...
                        <form action="analisar-hipotese" method="post">
                        	<div class="col-xl-12">
                                ...
                                <div class="card">
                                    <h4 class="card-header expandir">Sintomas</h4>
                                    <div class="card-body"> 
                                        	<c:forEach items="${sintomas}" var="sintoma">
                                        		<label class="custom-control custom-checkbox">
                                                	<input type="checkbox" onclick="return false" checked="checked" name="sintomasCaso" value="${sintoma.iriSintoma}" class="custom-control-input"><span class="custom-control-label">${sintoma.nomeSintoma}</span>
                                            	</label>
                                        	</c:forEach>
                                    </div>
                                </div>
                           	</div>
                           	<input type="text" value="analisar-caso-teste" name="link" hidden readonly="readonly"/>
                            <div class="col-xl-12">
                                <div class="section-block">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body"> 
										<input id="tempo" value="${tempo}" name="tempoSintomasCaso" min="0" placeholder="Ex.: 15" max="1080" type="number" class="form-control">					
                                    </div>
                                </div>
                           	</div>   
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body"> 
                                        <c:forEach items="${situacoes}" var="situacao">
                                        	<label class="custom-control custom-checkbox">
                                                <input type="checkbox" checked="checked" onclick="return false" name="situacoesCaso" value="${situacao.iriSituacao}" class="custom-control-input"><span class="custom-control-label">${situacao.nomeSituacao}</span>
                                            </label>
                                        </c:forEach> 
                                    </div>
                                </div>
